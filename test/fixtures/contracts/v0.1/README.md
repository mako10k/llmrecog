...
route exists. Implemented Phase 2, Phase 3, Phase 4 relational, query, and
materialization outputs match their artifacts through real seams. Accepted
text goldens use UTF-8, LF, and one final newline and are projections of their
adjacent JSON result goldens.
...
route by themselves; both bounded routes are implemented under the separately
